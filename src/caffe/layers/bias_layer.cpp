...
template <typename Dtype>
void BiasLayer<Dtype>::Forward_cpu(const int log_num_,const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  ...
  //====debugPrint Begin by cqiu
      ...
      sprintf(oFileName,"cnnData/ScaleBeta%d.bin",log_num_);
      oFile = fopen(oFileName, "w+");
      const Dtype *log_bias_data = bias_data;
